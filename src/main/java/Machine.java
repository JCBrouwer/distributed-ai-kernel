...
public class Machine {
    ...
    public void updateMU(Machine other) {
        ...
        double interm_intercept = DerivativeWithRespectToIntercept(this.pair.Y(), avg_intercept, this.pair.X(),
                avg_bias);
    ...
    public void updateUM(Machine other) {
        double interm_intercept = DerivativeWithRespectToIntercept(this.pair.Y(), this.getIntercept(), this.pair.X(),
                this.getBias());
        double interm_slope = DerivativeWithRespectToSlope(this.pair.Y(), this.getIntercept(), this.pair.X(),
                this.getBias());
        ...
        double interm_intercept2 = DerivativeWithRespectToIntercept(this.pair.Y(), other.getIntercept(), this.pair.X(),
                other.getBias());
        double interm_slope2 = DerivativeWithRespectToSlope(this.pair.Y(), other.getIntercept(), this.pair.X(),
                other.getBias());
    ...
    public String toString() {
        return "Machine{" + "intercept=" + intercept + ", bias=" + bias + '}';
    }
